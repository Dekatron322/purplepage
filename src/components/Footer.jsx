		...
		<footer>
			<div className='container footer__container'>
				...
				<article>
					...
					<Link to='/'>Home</Link>
					<a
						href='https://www.usepurplepages.com/about'
						rel='noreferre noopener'
					>
						About Us
					</a>
					<a
						href='https://www.usepurplepages.com/contact'
						rel='noreferre noopener'
					>
						Contact
					</a>
				...
				<article>
					<h4>Help & Support</h4>
					<a href='https://www.usepurplepages.com/faq' rel='noreferre noopener'>
						FAQs
					</a>
					<a
						href='https://www.usepurplepages.com/privacy-policy'
						rel='noreferre noopener'
					>
						Privacy Policy
					</a>
					<a
						href='https://www.usepurplepages.com/terms'
						rel='noreferre noopener'
					>
						Terms & Conditions
					</a>
				...
				<article>
					<h4>Contact Us</h4>
					<a
						href='mailto:hello@www.usepurplepages.com'
						rel='noreferre noopener'
					>
						<AiOutlineMail className='contact__icon' />
						hello@www.usepurplepages.com
					</a>
